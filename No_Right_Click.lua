-- This function runs when the addon is loaded
function RightClickLock()
    ...
    f2:SetAttribute("_onstate-mov", "if newstate==1 then self:SetBindingClick(1,'BUTTON2','mlook') else self:ClearBindings() end")
end
